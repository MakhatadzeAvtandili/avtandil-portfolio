...
const Footer = () => {
  ...
  const navLinks = [
    { href: "#workflow", label: t("header.about") },
    ...
    <footer className="bg-white border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <Link
            to="/"
            className="text-3xl font-bold tracking-tight text-text-primary mb-6 inline-block"
          >
            Avtandili<span className="text-primary">.</span>
          </Link>

          <nav className="flex justify-center flex-wrap gap-x-8 gap-y-4 mb-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
